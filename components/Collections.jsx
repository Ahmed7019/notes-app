...
function Collections({ collections, notes, setNotes }) {
  return (
    <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 md:grid-cols-3 gap-6 my-8 w-full">
...
function Collection({ collection }) {
  return (
    <Dialog>
      ...
      <DialogContent className="lg:max-w-5xl md:max-w-2xl h-fit bg-neutral-50 overflow-y-auto ">
